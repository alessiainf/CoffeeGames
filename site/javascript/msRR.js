document.addEventListener('DOMContentLoaded', () => {
  ...
  const grid = document.querySelector('.gridRR')
  ...
  function createBoard() {
    ...
    const bombsArray = Array(bombAmount).fill('bombNormal')     // 'bombNormal' is defined in css file
    const emptyArray = Array(width*height - bombAmount).fill('validNormal')    // 'validNormal' is defined in css file
